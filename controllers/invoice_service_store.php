...
$monto_total = $item1_valor + $item2_valor + $item3_valor;

//Guardando datos en la BD

$save_invoice = connect();
$save_invoice = $save_invoice->prepare("INSERT INTO invoices_service (contribuyente_id, creado_por, tipo, nota, item1, item1_valor, item2, item2_valor, item3, item3_valor, monto_total) VALUES (:contribuyente_id, :creado_por, :tipo, :nota, :item1, :item1_valor, :item2, :item2_valor, :item3, :item3_valor, :monto_total)");
