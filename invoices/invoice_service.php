...
$id = $_GET['id'];
$data = connect();
$data = $data->query("SELECT DISTINCT invoices_service.*, contributors.*
FROM invoices_service
INNER JOIN contributors
ON invoices_service.contribuyente_id = contributors.id
WHERE invoices_service.id = $id");
...
<body>
    <!-- encabezado -->
    <div class="header">
        <img src="../assets/img/logo-aseo.png" alt="Logo">
